sap.ui.define([
	...
	return BaseController.extend("com.rizing.tableit.controller.MasterMain", {
	formatter: formatter,
		...
		onInit: function () {
			...
			// 	intent: "#CreatePhysicalInventory-display"
			// }, true);
		},
		 ...
		 * @public
		 */
		onPressWorklistItem: function (oEvent) {
		...
		_showObject: function (oItem) {
			this.getRouter().navTo("main", {
				...
				sTableName: oItem.getBindingContext().getProperty("TableName"),
				sDescription:  oItem.getBindingContext().getProperty("TableName"),
			});
		},
